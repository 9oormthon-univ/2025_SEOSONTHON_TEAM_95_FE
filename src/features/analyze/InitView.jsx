  ...
  return (
    <div className="dash-wrap">
      ...
      <div className="kpi-row">
        <KpiCard title="Daily Scans" value={stats.total} />
        <KpiCard title="Fake Detected" value={stats.fake} tone="pink" />
        <KpiCard
          title="Fake Rate"
          value={stats.total ? ((stats.fake / stats.total) * 100).toFixed(1) + "%" : "0%"}
          tone="orange"
        />
        <KpiCard
          title="AI Suspected Rate"
          value={stats.total ? ((stats.suspect / stats.total) * 100).toFixed(1) + "%" : "0%"}
          tone="orange2"
        />
      </div>
